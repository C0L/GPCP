...
HD_PWD='/home/colindrewes/dev/GPCP/build/design/picorv32/axi/picorv32/picorv32.runs/picorv32_riscvBramController_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log picorv32_riscvBramController_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source picorv32_riscvBramController_0.tcl
