...
HD_PWD='/home/colindrewes/dev/GPCP/build/design/picorv32/axi/picorv32/picorv32.runs/picorv32_auto_pc_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log picorv32_auto_pc_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source picorv32_auto_pc_3.tcl
