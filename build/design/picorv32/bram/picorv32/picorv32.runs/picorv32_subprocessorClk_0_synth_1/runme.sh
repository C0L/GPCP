...
HD_PWD='/home/colindrewes/dev/RISC-V-On-PYNQ/riscvonpynq/picorv32/bram/picorv32/picorv32.runs/picorv32_subprocessorClk_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log picorv32_subprocessorClk_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source picorv32_subprocessorClk_0.tcl
