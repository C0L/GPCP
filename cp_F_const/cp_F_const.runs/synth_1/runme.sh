...
HD_PWD='/data/cdrewes/GPCP/cp_F_const/cp_F_const.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cp_const.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cp_const.tcl
