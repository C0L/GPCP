...
HD_PWD='/data/cdrewes/GPCP/cp_F_const/cp_F_const.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cp_const.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cp_const.tcl -notrace
