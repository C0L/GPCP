...
proc create_root_design { parentCell } {
  ...
  set block_cell_name coprocessor_0
  if { [catch {set coprocessor_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $coprocessor_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net processor_ip_pcpi_1 [get_bd_intf_pins coprocessor_0/ip_pcpi] [get_bd_intf_pins processor/ip_pcpi_1]
  ...
  connect_bd_net -net subprocessorClk_clk_out1 [get_bd_pins coprocessor_0/clk] [get_bd_pins processor/riscv_clk] [get_bd_pins subprocessorClk/clk_out1]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces processor/picorv32/mem_axi] [get_bd_addr_segs processor/riscvBramController/S_AXI/Mem0] SEG_riscvBramController_Mem0
