...
################################################################
# This is a generated script based on design: cp_popcount
#
...
colindrewes.com:colindrewes:cp_popount:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create instance: cp_popount_0, and set properties
  set cp_popount_0 [ create_bd_cell -type ip -vlnv colindrewes.com:colindrewes:cp_popount:1.0 cp_popount_0 ]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins cp_popount_0/clk]
  connect_bd_net -net cp_popount_0_done [get_bd_ports done] [get_bd_pins cp_popount_0/done]
  connect_bd_net -net cp_popount_0_pcpi_rd [get_bd_ports pcpi_rd] [get_bd_pins cp_popount_0/pcpi_rd]
  connect_bd_net -net pcpi_rs1_1 [get_bd_ports pcpi_rs1] [get_bd_pins cp_popount_0/pcpi_rs1]
  connect_bd_net -net pcpi_rs2_1 [get_bd_ports pcpi_rs2] [get_bd_pins cp_popount_0/pcpi_rs2]
  ...
  connect_bd_net -net trigger_1 [get_bd_ports trigger] [get_bd_pins cp_popount_0/trigger]
