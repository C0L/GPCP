...
HD_PWD='/data/cdrewes/GPCP/designs/build/axi/picorv32/picorv32.runs/cp_reflect_pd_pr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cp_reflect_pd_pr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cp_reflect_pd_pr_0.tcl
