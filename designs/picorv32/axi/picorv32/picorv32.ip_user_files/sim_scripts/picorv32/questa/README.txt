...
#
# Generated by export_simulation on Fri Sep 24 19:47:09 PDT 2021
#
################################################################################
...
'-reset_run' switch to the './picorv32.sh' script.

./picorv32.sh -reset_run
...
./picorv32.sh -noclean_files

For more information on the script, please type './picorv32.sh -help'.
